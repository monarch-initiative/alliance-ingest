...
def mgi_agm_row():
    return {
        'Taxon': 'NCBITaxon:10090', 'SpeciesName': 'Mus musculus', 'DBobjectType': 'affected_genomic_model',
...
@pytest.fixture
def mgi_agm(mgi_agm_row):
    return transform_record(None, mgi_agm_row)
...
def zfin_agm_row():
    return {
        'Taxon': 'NCBITaxon:7955', 'SpeciesName': 'Danio rerio', 'DBobjectType': 'affected_genomic_model',
        'DBObjectID': 'ZFIN:ZDB-FISH-160908-10', 'DBObjectSymbol': 'TU + MO2-mybpc2b', 'AssociationType': 'is_model_of',
        'DOID': 'DOID:423', 'DOtermName': 'myopathy', 'WithOrtholog': '', 'InferredFromID': '',
        'InferredFromSymbol': '', 'ExperimentalCondition': 'Has Condition: standard conditions', 'Modifier': '',
        'EvidenceCode': 'ECO:0000305', 'EvidenceCodeName': 'curator inference used in manual assertion',
        'Reference': 'PMID:27022191', 'Date': '20240314', 'Source': 'ZFIN'
    }

@pytest.fixture
def zfin_agm(zfin_agm_row):
    return transform_record(None, zfin_agm_row)
...
@pytest.fixture
def zfin_agm_chemical_environment_row():
    return {
        'Taxon': 'NCBITaxon:7955', 'SpeciesName': 'Danio rerio', 'DBobjectType': 'affected_genomic_model',
        'DBObjectID': 'ZFIN:ZDB-FISH-150901-29105', 'DBObjectSymbol': 'WT', 'AssociationType': 'is_model_of',
        'DOID': 'DOID:0060668', 'DOtermName': 'anencephaly', 'WithOrtholog': '', 'InferredFromID': '',
        'InferredFromSymbol': '', 'ExperimentalCondition': 'Has Condition: chemical treatment by environment: SU5402',
        'Modifier': '', 'EvidenceCode': 'ECO:0000305', 'EvidenceCodeName': 'curator inference used in manual assertion',
        'Reference': 'PMID:29488319', 'Date': '20240314', 'Source': 'ZFIN'
    }

@pytest.fixture
def zfin_agm_chemical_environment(zfin_agm_chemical_environment_row):
    return transform_record(None, zfin_agm_chemical_environment_row)
