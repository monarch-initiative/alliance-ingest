...
def mouse(mgi_row):
    ...
    return transform_record(koza_transform, mgi_row)
...
@pytest.fixture
def zebrafish(zfin_row):
    koza_transform = KozaTransform(
        mappings={},
        writer=PassthroughWriter(),
        extra_fields={}
    )
    return transform_record(koza_transform, zfin_row)
...
@pytest.fixture
def drosophila(fly_row):
    koza_transform = KozaTransform(
        mappings={},
        writer=PassthroughWriter(),
        extra_fields={}
    )
    return transform_record(koza_transform, fly_row)
...
def worm(worm_row):
    ...
    return transform_record(koza_transform, worm_row)
...
def yeast(sgd_row):
    ...
    return transform_record(koza_transform, sgd_row)
